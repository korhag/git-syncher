...
from app.ui.layout import contentWidth
...
class UnlockView:
    ...
    def build(self) -> ft.Control:
        form_width = contentWidth(self.page, preferred=360)
        title_text = ft.Text(
        ...
        error_text = ft.Text("", color=ft.Colors.RED_400, size=13, width=form_width)
